...
int32_t wwl_get_width(struct wwl_state *state);
int32_t wwl_get_height(struct wwl_state *state);

typedef void (*wwl_resize_callback_func)(int32_t *new_width, int32_t *new_height);
void wwl_set_resize_callback(wwl_resize_callback_func);
